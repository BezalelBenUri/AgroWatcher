...
start-services:
	@echo -e "$(GREEN)Starting the AgroWatchers services:$(COFF)"
	@docker-compose up

start-services-detached:
	@echo -e "$(GREEN)Starting AgroWatchers services in the background:$(COFF)"
	@docker-compose up -d

start-client:
	echo -e "$(GREEN)Starting AgroClients services:$(COFF)"
	@docker-compose up awatcher-frontend

start-client-deteched:
	echo -e "$(GREEN)Starting AgroClients services in the background:$(COFF)"
	@docker-compose up -d awatcher-frontend
...
stop-services:
	@echo -e "$(RED)Stopping AgroWatchers services:$(COFF)"
	@docker-compose down
